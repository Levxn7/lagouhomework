...
},{}],"src/01-basicusage.js":[function(require,module,exports) {
"use strict";
...
function movieView(movie, index) {
  ...
  }, movie.rank), (0, _h.h)("div", movie.title), (0, _h.h)("div", movie.desc), (0, _h.h)("button.btn.rm-btn", {
    on: {
...
function view(data) {
  return (0, _h.h)("div", [(0, _h.h)("h1", "Top 10 movies"), (0, _h.h)("div", [(0, _h.h)("button.add", {
    on: {
      click: add
    }
  }, " 添加 "), "排序方式: ", (0, _h.h)("span.btn-group", [(0, _h.h)("button.rank", {
    class: {
      active: sortBy === "rank"
    },
    on: {
...
var addEl = document.querySelector('#app');
